...
assetEntriesSearchFacetDisplayBuilder.setParamName(facet.getFieldId());
assetEntriesSearchFacetDisplayBuilder.setParamValue(fieldParam);
assetEntriesSearchFacetDisplayBuilder.setPermissionChecker(themeDisplay.getPermissionChecker());
