...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<div class="portlet-configuration-body-content">
		<div class="container-fluid-1280">
			...
			<aui:input label="portlet.search-results.start-page-parameter-name" name="<%= PortletPreferencesJspUtil.getInputName(SearchResultsPortletPreferences.PREFERENCE_START_PAGE_PARAMETER_NAME) %>" value="<%= searchResultsPortletPreferences.getStartPageParameterName() %>" />
		</div>
	</div>
