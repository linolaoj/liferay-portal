	...
	<div class="portlet-configuration-body-content">
		<div class="container-fluid-1280">
			<aui:fieldset>
				...
				<aui:input label="portlet.search-bar.auto-complete-url" name="<%= PortletPreferencesJspUtil.getInputName(SearchBarPortletPreferences.PREFERENCE_AUTOCOMPLETE_URL) %>" value="<%= searchBarPortletPreferences.getAutocompleteURLString() %>" />
			</aui:fieldset>
		</div>
	</div>
