...
<%@ page import="com.liferay.portal.search.web.internal.facet.display.builder.ModifiedSearchFacetDisplayBuilder" %><%@
page import="com.liferay.portal.search.web.internal.facet.display.context.ModifiedSearchFacetDisplayContext" %><%@
page import="com.liferay.portal.search.web.internal.facet.display.context.ModifiedSearchFacetFieldDisplayContext" %><%@
...
List<TermCollector> termCollectors = java.util.Collections.<TermCollector>emptyList();
