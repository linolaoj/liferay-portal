...
<%@ page import="com.liferay.portal.search.web.internal.portlet.bar.SearchBarPortletDisplayContext" %>

<portlet:defineObjects />

<%
SearchBarPortletDisplayContext searchBarPortletDisplayContext =
	(SearchBarPortletDisplayContext)java.util.Objects.requireNonNull(
		request.getAttribute(SearchBarPortletDisplayContext.ATTRIBUTE));
%>
