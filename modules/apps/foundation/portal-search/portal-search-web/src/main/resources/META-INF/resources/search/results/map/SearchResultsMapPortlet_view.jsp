...
com.liferay.portal.search.web.internal.search.results.map.portlet.SearchResultsMapDisplayContext dc =
	(com.liferay.portal.search.web.internal.search.results.map.portlet.SearchResultsMapDisplayContext)java.util.Objects.requireNonNull(
		request.getAttribute(com.liferay.portal.search.web.internal.search.results.map.portlet.SearchResultsMapDisplayContext.ATTRIBUTE));
%>
