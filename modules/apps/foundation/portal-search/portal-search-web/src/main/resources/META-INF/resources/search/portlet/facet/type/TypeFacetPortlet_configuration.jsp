...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<div class="portlet-configuration-body-content">
		<div class="container-fluid-1280">
			<aui:input label="param-name" name="<%= PortletPreferencesJspUtil.getInputName(typeFacetPortletPreferences.PREFERENCE_PARAM_NAME) %>" value="<%= typeFacetPortletPreferences.getParamName() %>" />
