...
public class SiteFacetPortletDisplayContext {
	...
	public Collection<SiteFacetPortletTermDisplayContext> getTermDisplayContexts() {
	...
	private Collection<SiteFacetPortletTermDisplayContext> _termDisplayContexts = Collections.emptyList();
