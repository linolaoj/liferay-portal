...
public class SearchResultsSearchContainerUtil {
	...
	public static SearchContainer<Document> getSearchContainer(
		...
		PortletURL iteratorURL = cleanPortletURL(httpServletRequest);
	...
	protected static PortletURL cleanPortletURL(
		...
		url = HttpUtil.removeParameter(
			url, SearchResultsPortletKeys.DEFAULT_FROM_PARAMETER_NAME);
