...
public class AssetTagsFacetPortlet extends MVCPortlet 
	implements SearchAwarePortlet {
	@Override
	...
	protected AssetTagsFacetPortletTermDisplayContext getTermDisplayContext(
			...
			termDisplayContext.setDisplayName(
			...
			termDisplayContext.setPopularity(
	...
	private AssetTagsFacetPortletDisplayContext buildDisplayContext(
			...
			boolean cloudWithCount = assetTagsSearchFacetDisplayContext.isCloudWithCount();
			String displayStyle = assetTagsSearchFacetDisplayContext.getDisplayStyle();
			String facetLabel = assetTagsSearchFacetDisplayContext.getFacetLabel();
			...
			assetTagsFacetPortletDisplayContext.setCloudWithCount(cloudWithCount);
			assetTagsFacetPortletDisplayContext.setDisplayStyle(displayStyle);
			assetTagsFacetPortletDisplayContext.setFacetLabel(facetLabel);
