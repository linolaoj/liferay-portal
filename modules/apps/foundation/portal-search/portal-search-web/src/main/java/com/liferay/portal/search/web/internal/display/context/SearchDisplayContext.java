...
import com.liferay.portal.search.web.internal.portlet.SearchPortletKeywordsSearchContributor;
...
public class SearchDisplayContext {
	...
	public SearchDisplayContext(
		...
		SearchContributor searchContributor1 =
			new SearchPortletKeywordsSearchContributor(keywords);

		SearchContributor searchContributor2 =
		...
		SearchContributorsSupplier searchContributorsSupplier =
			() -> Arrays.asList(searchContributor1, searchContributor2);
