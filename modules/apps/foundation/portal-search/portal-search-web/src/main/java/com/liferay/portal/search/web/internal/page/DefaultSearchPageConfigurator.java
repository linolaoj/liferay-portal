...
public class DefaultSearchPageConfigurator {
	...
	protected void importPage(long companyId, long groupId)
		throws Exception {
	...
	protected boolean isPagePresent(long groupId) {
	...
	@Reference
	protected ExportImportConfigurationLocalService _exportImportConfigurationLocalService;

	@Reference
	protected ExportImportLocalService _exportImportLocalService;
