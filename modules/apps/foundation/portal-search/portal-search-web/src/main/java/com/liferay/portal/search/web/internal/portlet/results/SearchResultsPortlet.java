...
public class SearchResultsPortlet
	...
	protected SearchResultsDisplayContext buildDisplayContext(
		...
		int paginationStart = searchResponse.getPaginationStart();

		String paginationStartParameterName =
			searchResultsPortletPreferences.getPaginationStartParameterName();

		int paginationDelta = searchResponse.getPaginationDelta();
	...
	protected SearchContainer<Document> buildSearchContainer(
		...
		SearchContainer<Document> searchContainer = new SearchContainer<>(
			portletRequest, displayTerms, searchTerms, curParam, cur,
			paginationDelta, iteratorURL, headerNames, emptyResultsMessage,
			cssClass);
