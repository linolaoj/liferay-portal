 ...
 * @author Lino Alves
 */
public class FolderFacetPortletDisplayContext {

	public static final String ATTRIBUTE = "FolderFacetPortletDisplayContext";

	public String getFieldParamInputValue() {
		return _fieldParamInputValue;
	}

	public Collection<FolderFacetPortletTermDisplayContext>
	...
	public void setTerms(
		Collection<FolderFacetPortletTermDisplayContext> termDisplayContexts) {
	...
	private Collection<FolderFacetPortletTermDisplayContext>
