...
import com.liferay.portal.search.web.internal.request.helper.LiferayPortletRequestUtil;
...
public class FolderFacetPortlet
	...
	public void contribute(
		...
		filter(folderFacetPortletPreferences, portletSharedSearchSettings);

		aggregate(folderFacetPortletPreferences, portletSharedSearchSettings);
	}
	...
	protected void aggregate(
		...
		Facet facet = folderFacetBuilder.build();
	...
	protected FolderSearchFacetDisplayContext buildDisplayContext(
		...
		FolderFacetPortletPreferences folderFacetPortletPreferences =
			new FolderFacetPortletPreferencesImpl(
				portletSharedSearchResult.getPortletPreferences());

		String paramName = _PARAM;

		Optional<String[]> paramValuesOptional =
			portletSharedSearchResult.getParameterValues(paramName);
	...
	protected void filter(
		...
		paramValuesOptional.ifPresent(
			paramValues -> {
				...
				searchContext.setFolderIds(ArrayUtil.toLongArray(paramValues));
			});
	}
