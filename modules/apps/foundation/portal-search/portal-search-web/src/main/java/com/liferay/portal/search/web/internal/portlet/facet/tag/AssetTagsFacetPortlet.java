...
public class AssetTagsFacetPortlet extends MVCPortlet implements SearchAwarePortlet{
	...
	public void contribute(
		...
		AssetTagsFacetPortletPreferences assetTagsFacetPortletPreferences =
			new AssetTagsFacetPortletPreferencesImpl(
		...
		searchBuilder.addFacet(
			buildFacet(assetTagsFacetPortletPreferences, searchContext));
	}
	...
	protected AssetTagsSearchFacetDisplayContext buildDisplayContext(
		...
		Facet facet = result.getFacet(AssetTagsFacetConstants.FIELD_NAME);
		...
		int frequencyThreshold = assetTagsFacetConfiguration.getFrequencyThreshold();
		int maxTerms = assetTagsFacetConfiguration.getMaxTerms();

		PortletPreferences portletPreferences = renderRequest.getPreferences();

		AssetTagsFacetPortletPreferences assetTagsFacetPortletConfiguration =
			new AssetTagsFacetPortletPreferencesImpl(portletPreferences);
		...
		assetTagsSearchFacetDisplayBuilder.setFrequenciesVisible(frequenciesVisible);
		assetTagsSearchFacetDisplayBuilder.setFrequencyThreshold(frequencyThreshold);
	...
	protected MultiValueFacet buildFacet(
		...
		assetTagsFacetBuilder.setFrequencyThreshold(
			assetTagsFacetPortletPreferences.getFrequencyThreshold());
		assetTagsFacetBuilder.setMaxTerms(
			assetTagsFacetPortletPreferences.getMaxTerms());
