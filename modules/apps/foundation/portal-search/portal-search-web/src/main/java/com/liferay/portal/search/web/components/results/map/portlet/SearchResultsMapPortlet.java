...
public class SearchResultsMapPortlet extends MVCPortlet {
	...
	public void render(
		...
		SearchResultsMapConfigurationImpl searchParametersConfiguration =
		...
		SearchParameters searchParameters =
			getSearchParameters(renderRequest, searchParametersConfiguration);

		String qParameter = searchParameters.getQParameter();
		...
		SearchResultsMapDisplayContext searchResultsMapDisplayContext =
			new SearchResultsMapDisplayContext(
				searchResultsData, qParameter, mapMarkersJSON);
