...
public class UserFacetPortlet extends MVCPortlet implements SearchAwarePortlet {
	...
	public void render(
		...
		try {
			...
			SessionErrors.add(renderRequest, "userNotFound");
		}
	...
	protected UserFacetPortletTermDisplayContext getTermDisplayContext(
		...
		termDisplayContext.setTerm(
			getUserName(userSearchFacetTermDisplayContext));
	...
	protected String getUserName(
		...
		try {
			return userSearchFacetTermDisplayContext.getUserName();
		}
		catch (PortalException pe) {
	...
	private UserFacetPortletDisplayContext buildDisplayContext(
		...
		throws PortalException {
			...
			UserSearchFacetDisplayContext userSearchFacetDisplayContext =
				new UserSearchFacetDisplayContext(
					facet, fieldParam, countThreshold, maxTerms,
					showFrequencies);

			return buildDisplayContext(
				fieldParam, showFrequencies, userSearchFacetDisplayContext);
	}
	...
	private List<UserFacetPortletTermDisplayContext> buildTermDisplayContexts(
			...
			for (UserSearchFacetTermDisplayContext
				...
				UserFacetPortletTermDisplayContext termDisplayContext =
					getTermDisplayContext(
						showCounts, userSearchFacetTermDisplayContext);
