 ...
 * @author Lino Alves
 */
public class UserFacetPortletDisplayContext {

	public static final String ATTRIBUTE = "UserFacetPortletDisplayContext";

	public String getFieldParamInputValue() {
		return _fieldParamInputValue;
	}

	public Collection<UserFacetPortletTermDisplayContext>
	...
	public void setTerms(
		Collection<UserFacetPortletTermDisplayContext> termDisplayContexts) {
	...
	private Collection<UserFacetPortletTermDisplayContext>
