 ...
 * @author Lino Alves
 */
public class FolderFacetConfigurationImpl implements FolderFacetConfiguration {

	public FolderFacetConfigurationImpl(FacetConfiguration facetConfiguration) {
