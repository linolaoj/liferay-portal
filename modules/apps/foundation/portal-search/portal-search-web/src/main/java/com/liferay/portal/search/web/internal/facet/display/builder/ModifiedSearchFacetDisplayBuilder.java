...
public class ModifiedSearchFacetDisplayBuilder implements Serializable{
	...
	public ModifiedSearchFacetDisplayContext build()
		...
		modifiedSearchFacetDisplayContext.setParamValue(
			_paramValue);
		...
		int customRangeIndex = termDisplayContexts.size() + 1;		
		modifiedSearchFacetDisplayContext.setCustomRangeTermDisplayContext(
			buildCustomRangeTermDisplayContext(customRangeIndex));
	...
	protected ModifiedSearchFacetTermDisplayContext 
		buildCustomRangeTermDisplayContext(int index) {
		
		boolean selected = isSelected(index);
		Map<String, Object> data = new HashMap<>();
		
		FacetCollector facetCollector =_facet.getFacetCollector();
		TermCollector termCollector = facetCollector.getTermCollector(_paramValue);
	...
	protected ModifiedSearchFacetTermDisplayContext 
		...
		ModifiedSearchFacetTermDisplayContext
			defaultTermDisplayContext = 
				buildTermDisplay(
					_facet.getFacetConfiguration().getLabel(),
					_paramSelection.equals("0"),
					data, 0);
