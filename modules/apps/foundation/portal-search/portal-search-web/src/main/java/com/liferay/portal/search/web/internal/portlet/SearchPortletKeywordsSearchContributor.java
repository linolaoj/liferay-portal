 ...
 */
public class SearchPortletKeywordsSearchContributor
	implements SearchContributor {

	public SearchPortletKeywordsSearchContributor(String keywords) {
		_keywords = keywords;
	}

	@Override
	public void contribute(SearchSettings searchSettings) {
		searchSettings.setKeywords(_keywords);
	}
