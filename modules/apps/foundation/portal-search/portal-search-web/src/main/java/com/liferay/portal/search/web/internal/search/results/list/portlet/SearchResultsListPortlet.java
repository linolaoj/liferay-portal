...
public class SearchResultsListPortlet extends MVCPortlet {
	...
	protected SearchResultsListDisplayContext buildDisplayContext(
		PortletSharedSearchResult portletSharedSearchResult) {

		SearchResultsData searchResultsData =
			portletSharedSearchResult.getSearchResultsData();

		return new SearchResultsListDisplayContext(
			searchResultsData, searchResultsData.getKeywords());
	}
