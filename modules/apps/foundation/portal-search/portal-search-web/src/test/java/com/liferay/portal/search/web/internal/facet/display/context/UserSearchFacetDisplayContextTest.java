...
public class UserSearchFacetDisplayContextTest {
	...
	public void testEmptySearchResults() throws Exception {
		...
		Assert.assertEquals(
			facetParam,
			userSearchFacetDisplayContext.getFieldParamInputValue());
	...
	public void testEmptySearchResultsWithPreviousSelection() throws Exception {
		...
		Assert.assertTrue(userSearchFacetTermDisplayContext.isShowFrequency());
	...
	protected UserSearchFacetDisplayContext createDisplayContext(
		...
		return new UserSearchFacetDisplayContext(
			_facet, facetParam, 0, 0, true);
	}
