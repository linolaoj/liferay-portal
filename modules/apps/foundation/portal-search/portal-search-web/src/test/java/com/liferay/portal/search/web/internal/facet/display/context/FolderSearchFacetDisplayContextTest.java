...
public class FolderSearchFacetDisplayContextTest {
	...
	public void testEmptySearchResults() throws Exception {
		...
		Assert.assertEquals(
			facetParam,
			folderSearchFacetDisplayContext.getParamValue());
	...
	protected FolderSearchFacetDisplayContext createDisplayContext(
		...
		folderSearchFacetDisplayBuilder.setFolderTitleLookup(_folderTitleLookup);
		...
		folderSearchFacetDisplayBuilder.setParamName(_facet.getFieldId());
		folderSearchFacetDisplayBuilder.setParamValue(facetParam);
